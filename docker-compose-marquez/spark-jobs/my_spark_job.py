...
locations = (
    ...
    .csv("file:///opt/bitnami/spark/data/input/locations.csv")
)
...
user_favorites = (
    spark.read.option("header", "true")
    .option("inferschema", "true")
    .csv("file:///opt/bitnami/spark/data/input/user_favorites.csv")
)
...
nicknames.write.mode("overwrite").csv("file:///opt/bitnami/spark/data/output/nicknames")
